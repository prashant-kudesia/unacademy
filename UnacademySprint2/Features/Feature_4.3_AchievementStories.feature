...
@tag
Feature: Verification of achivement stories of students
 Background: User Login in Unacademy
  ...
  @tag1
  Scenario: To validate that the students achivement details are present on the center of the page with their images and link will redirect to video.
